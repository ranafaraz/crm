...
<?php } ?>
<form name="fdesignationlist" id="fdesignationlist" class="ew-horizontal ew-form ew-list-form ew-multi-column-form" action="<?php echo CurrentPageName() ?>" method="post">
...
?>
<div class="<?php echo $designation_list->getMultiColumnClass() ?>" <?php echo $designation->rowAttributes() ?>>
	<div class="card ew-card">
	<div class="card-body">
	<?php if ($designation->RowType == ROWTYPE_VIEW) { // View record ?>
	<table class="table table-striped table-sm ew-view-table">
	<?php } ?>
	<?php if ($designation_list->designation_id->Visible) { // designation_id ?>
		<?php if ($designation->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $designation_list->TableLeftColumnClass ?>"><span class="designation_designation_id">
<?php if ($designation_list->isExport() || $designation_list->SortUrl($designation_list->designation_id) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $designation_list->designation_id->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $designation_list->SortUrl($designation_list->designation_id) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $designation_list->designation_id->cellAttributes() ?>>
...
<span<?php echo $designation_list->designation_id->viewAttributes() ?>><?php echo $designation_list->designation_id->getViewValue() ?></span>
		...
		<div class="form-group row designation_designation_id">
			<label class="<?php echo $designation_list->LeftColumnClass ?>"><?php echo $designation_list->designation_id->caption() ?></label>
			<div class="<?php echo $designation_list->RightColumnClass ?>"><div <?php echo $designation_list->designation_id->cellAttributes() ?>>
<span id="el<?php echo $designation_list->RowCount ?>_designation_designation_id">
<span<?php echo $designation_list->designation_id->viewAttributes() ?>><?php echo $designation_list->designation_id->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($designation_list->designation_caption->Visible) { // designation_caption ?>
		<?php if ($designation->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $designation_list->TableLeftColumnClass ?>"><span class="designation_designation_caption">
<?php if ($designation_list->isExport() || $designation_list->SortUrl($designation_list->designation_caption) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $designation_list->designation_caption->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $designation_list->SortUrl($designation_list->designation_caption) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $designation_list->designation_caption->cellAttributes() ?>>
...
<span<?php echo $designation_list->designation_caption->viewAttributes() ?>><?php echo $designation_list->designation_caption->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row designation_designation_caption">
			<label class="<?php echo $designation_list->LeftColumnClass ?>"><?php echo $designation_list->designation_caption->caption() ?></label>
			<div class="<?php echo $designation_list->RightColumnClass ?>"><div <?php echo $designation_list->designation_caption->cellAttributes() ?>>
<span id="el<?php echo $designation_list->RowCount ?>_designation_designation_caption">
<span<?php echo $designation_list->designation_caption->viewAttributes() ?>><?php echo $designation_list->designation_caption->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($designation_list->designation_desc->Visible) { // designation_desc ?>
		<?php if ($designation->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $designation_list->TableLeftColumnClass ?>"><span class="designation_designation_desc">
<?php if ($designation_list->isExport() || $designation_list->SortUrl($designation_list->designation_desc) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $designation_list->designation_desc->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $designation_list->SortUrl($designation_list->designation_desc) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $designation_list->designation_desc->cellAttributes() ?>>
...
<span<?php echo $designation_list->designation_desc->viewAttributes() ?>><?php echo $designation_list->designation_desc->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row designation_designation_desc">
			<label class="<?php echo $designation_list->LeftColumnClass ?>"><?php echo $designation_list->designation_desc->caption() ?></label>
			<div class="<?php echo $designation_list->RightColumnClass ?>"><div <?php echo $designation_list->designation_desc->cellAttributes() ?>>
<span id="el<?php echo $designation_list->RowCount ?>_designation_designation_desc">
<span<?php echo $designation_list->designation_desc->viewAttributes() ?>><?php echo $designation_list->designation_desc->getViewValue() ?></span>
</span>
</div></div>
...
$designation_list->ListOptions->render("body", "bottom", $designation_list->RowCount);
?>
