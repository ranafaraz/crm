		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php } ?>
				...
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($cus_support_add->cus_sup_branch_id->errorMessage()) ?>");
			...
			<?php } ?>
				elm = this.getElements("x" + infix + "_cus_sup_emp_id");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($cus_support_add->cus_sup_emp_id->errorMessage()) ?>");
			...
			<?php if ($cus_support_add->cus_sup_screen_shots->Required) { ?>
				...
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $cus_support_add->cus_sup_screen_shots->caption(), $cus_support_add->cus_sup_screen_shots->RequiredErrorMessage)) ?>");
			<?php } ?>
...
<input type="text" data-table="cus_support" data-field="x_cus_sup_branch_id" name="x_cus_sup_branch_id" id="x_cus_sup_branch_id" size="30" maxlength="12" placeholder="<?php echo HtmlEncode($cus_support_add->cus_sup_branch_id->getPlaceHolder()) ?>" value="<?php echo $cus_support_add->cus_sup_branch_id->EditValue ?>"<?php echo $cus_support_add->cus_sup_branch_id->editAttributes() ?>>
</span>
...
<input type="text" data-table="cus_support" data-field="x_cus_sup_emp_id" name="x_cus_sup_emp_id" id="x_cus_sup_emp_id" size="30" maxlength="12" placeholder="<?php echo HtmlEncode($cus_support_add->cus_sup_emp_id->getPlaceHolder()) ?>" value="<?php echo $cus_support_add->cus_sup_emp_id->EditValue ?>"<?php echo $cus_support_add->cus_sup_emp_id->editAttributes() ?>>
</span>
...
<?php if ($cus_support_add->cus_sup_query->Visible) { // cus_sup_query ?>
	<div id="r_cus_sup_query" class="form-group row">
		<label id="elh_cus_support_cus_sup_query" for="x_cus_sup_query" class="<?php echo $cus_support_add->LeftColumnClass ?>"><?php echo $cus_support_add->cus_sup_query->caption() ?><?php echo $cus_support_add->cus_sup_query->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($cus_support_add->cus_sup_screen_shots->Visible) { // cus_sup_screen_shots ?>
	<div id="r_cus_sup_screen_shots" class="form-group row">
		<label id="elh_cus_support_cus_sup_screen_shots" for="x_cus_sup_screen_shots" class="<?php echo $cus_support_add->LeftColumnClass ?>"><?php echo $cus_support_add->cus_sup_screen_shots->caption() ?><?php echo $cus_support_add->cus_sup_screen_shots->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<textarea data-table="cus_support" data-field="x_cus_sup_screen_shots" name="x_cus_sup_screen_shots" id="x_cus_sup_screen_shots" cols="35" rows="4" placeholder="<?php echo HtmlEncode($cus_support_add->cus_sup_screen_shots->getPlaceHolder()) ?>"<?php echo $cus_support_add->cus_sup_screen_shots->editAttributes() ?>><?php echo $cus_support_add->cus_sup_screen_shots->EditValue ?></textarea>
</span>
...
<input type="text" data-table="cus_support" data-field="x_cus_sup_date" name="x_cus_sup_date" id="x_cus_sup_date" maxlength="19" placeholder="<?php echo HtmlEncode($cus_support_add->cus_sup_date->getPlaceHolder()) ?>" value="<?php echo $cus_support_add->cus_sup_date->EditValue ?>"<?php echo $cus_support_add->cus_sup_date->editAttributes() ?>>
...
loadjs.ready(["fcus_supportadd", "datetimepicker"], function() {
	ew.createDateTimePicker("fcus_supportadd", "x_cus_sup_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($cus_support_add->cus_sup_comments->Visible) { // cus_sup_comments ?>
	<div id="r_cus_sup_comments" class="form-group row">
		<label id="elh_cus_support_cus_sup_comments" for="x_cus_sup_comments" class="<?php echo $cus_support_add->LeftColumnClass ?>"><?php echo $cus_support_add->cus_sup_comments->caption() ?><?php echo $cus_support_add->cus_sup_comments->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<script>
loadjs.ready(["fcus_supportadd", "datetimepicker"], function() {
	ew.createDateTimePicker("fcus_supportadd", "x_cus_sup_resolved_on", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
