...
<div class="btn-group ew-dropdown-list" role="group">
	<div class="btn-group" role="group">
		<button type="button" class="btn form-control dropdown-toggle ew-dropdown-toggle" aria-haspopup="true" aria-expanded="false"<?php if ($invoices_add->invoice_business_id->ReadOnly) { ?> readonly<?php } else { ?>data-toggle="dropdown"<?php } ?>><?php echo $invoices_add->invoice_business_id->ViewValue ?></button>
		<div id="dsl_x_invoice_business_id" data-repeatcolumn="1" class="dropdown-menu">
			<div class="ew-items" style="overflow-x: hidden;">
<?php echo $invoices_add->invoice_business_id->radioButtonListHtml(TRUE, "x_invoice_business_id") ?>
			</div><!-- /.ew-items -->
		</div><!-- /.dropdown-menu -->
		<div id="tp_x_invoice_business_id" class="ew-template"><input type="radio" class="custom-control-input" data-table="invoices" data-field="x_invoice_business_id" data-value-separator="<?php echo $invoices_add->invoice_business_id->displayValueSeparatorAttribute() ?>" name="x_invoice_business_id" id="x_invoice_business_id" value="{value}"<?php echo $invoices_add->invoice_business_id->editAttributes() ?>></div>
	</div><!-- /.btn-group -->
	<?php if (!$invoices_add->invoice_business_id->ReadOnly) { ?>
	<button type="button" class="btn btn-default ew-dropdown-clear" disabled>
		<i class="fas fa-times ew-icon"></i>
	</button>
	<?php } ?>
...
<div class="btn-group ew-dropdown-list" role="group">
	<div class="btn-group" role="group">
		<button type="button" class="btn form-control dropdown-toggle ew-dropdown-toggle" aria-haspopup="true" aria-expanded="false"<?php if ($invoices_add->invoice_service_id->ReadOnly) { ?> readonly<?php } else { ?>data-toggle="dropdown"<?php } ?>><?php echo $invoices_add->invoice_service_id->ViewValue ?></button>
		<div id="dsl_x_invoice_service_id" data-repeatcolumn="1" class="dropdown-menu">
			<div class="ew-items" style="overflow-x: hidden;">
<?php echo $invoices_add->invoice_service_id->radioButtonListHtml(TRUE, "x_invoice_service_id") ?>
			</div><!-- /.ew-items -->
		</div><!-- /.dropdown-menu -->
		<div id="tp_x_invoice_service_id" class="ew-template"><input type="radio" class="custom-control-input" data-table="invoices" data-field="x_invoice_service_id" data-value-separator="<?php echo $invoices_add->invoice_service_id->displayValueSeparatorAttribute() ?>" name="x_invoice_service_id" id="x_invoice_service_id" value="{value}"<?php echo $invoices_add->invoice_service_id->editAttributes() ?>></div>
	</div><!-- /.btn-group -->
	<?php if (!$invoices_add->invoice_service_id->ReadOnly) { ?>
	<button type="button" class="btn btn-default ew-dropdown-clear" disabled>
		<i class="fas fa-times ew-icon"></i>
	</button>
	<?php } ?>
