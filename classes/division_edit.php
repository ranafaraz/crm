 ...
 * Page class
 */
class division_edit extends division
{
	...
	// Page object name
	public $PageObjName = "division_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_division_id")) {
				$this->division_id->setFormValue($CurrentForm->getValue("x_division_id"));
			}
		} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->division_id->IsDetailKey)
			$this->division_id->setFormValue($val);
	...
	protected function validateForm()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return ($FormError == "");
		if ($this->division_id->Required) {
			if (!$this->division_id->IsDetailKey && $this->division_id->FormValue != NULL && $this->division_id->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->division_id->caption(), $this->division_id->RequiredErrorMessage));
			}
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// division_state_id
			$this->division_state_id->setDbValueDef($rsnew, $this->division_state_id->CurrentValue, 0, $this->division_state_id->ReadOnly);
