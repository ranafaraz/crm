...
class organization_add extends organization
{
	...
	protected function loadDefaultValues()
	{
		...
		$this->org_logo->CurrentValue = NULL;
		$this->org_logo->OldValue = $this->org_logo->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['org_logo'] = $this->org_logo->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// org_logo
		$this->org_logo->setDbValueDef($rsnew, $this->org_logo->CurrentValue, "", FALSE);
