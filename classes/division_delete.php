 ...
 * Page class
 */
class division_delete extends division
{
	...
	// Page object name
	public $PageObjName = "division_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("divisionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("divisionlist.php"); // Return to list
			}
		}
	}
