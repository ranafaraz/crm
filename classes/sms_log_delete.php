 ...
 * Page class
 */
class sms_log_delete extends sms_log
{
	...
	// Page object name
	public $PageObjName = "sms_log_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("sms_loglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("sms_loglist.php"); // Return to list
			}
		}
	}
