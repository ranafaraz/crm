 ...
 * Page class
 */
class referral_delete extends referral
{
	...
	// Page object name
	public $PageObjName = "referral_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("referrallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("referrallist.php"); // Return to list
			}
		}
	}
