 ...
 * Page class
 */
class sms_template_delete extends sms_template
{
	...
	// Page object name
	public $PageObjName = "sms_template_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("sms_templatelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("sms_templatelist.php"); // Return to list
			}
		}
	}
