 ...
 * Page class
 */
class state_addopt extends state
{
	...
	// Page object name
	public $PageObjName = "state_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->state_country_id->IsDetailKey) {
			$this->state_country_id->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->state_name->IsDetailKey) {
			$this->state_name->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->state_country_id->CurrentValue = ConvertToUtf8($this->state_country_id->FormValue);
		$this->state_name->CurrentValue = ConvertToUtf8($this->state_name->FormValue);
	}
