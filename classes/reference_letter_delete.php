 ...
 * Page class
 */
class reference_letter_delete extends reference_letter
{
	...
	// Page object name
	public $PageObjName = "reference_letter_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("reference_letterlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("reference_letterlist.php"); // Return to list
			}
		}
	}
