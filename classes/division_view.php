 ...
 * Page class
 */
class division_view extends division
{
	...
	// Page object name
	public $PageObjName = "division_view";
	...
	public function __construct()
	{
		...
		if (Get("division_id") !== NULL) {
			$this->RecKey["division_id"] = Get("division_id");
			$keyUrl .= "&amp;division_id=" . urlencode($this->RecKey["division_id"]);
		}
	...
	public function run()
	{
		...
		if (Get("division_id") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("division_id");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("division_id") !== NULL) {
				...
				$this->RecKey["division_id"] = $this->division_id->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->division_id->setQueryStringValue(Key(0));
				$this->RecKey["division_id"] = $this->division_id->QueryStringValue;
			} elseif (Post("division_id") !== NULL) {
				$this->division_id->setFormValue(Post("division_id"));
				$this->RecKey["division_id"] = $this->division_id->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->division_id->setFormValue(Route(2));
				$this->RecKey["division_id"] = $this->division_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecords <= 0) { // No record found
						...
						$this->terminate("divisionlist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (SameString($this->division_id->CurrentValue, $this->Recordset->fields('division_id'))) {
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "divisionlist.php"; // No matching record, return to list
					} else {
			...
			$returnUrl = "divisionlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fdivisionview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fdivisionview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fdivisionview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
