 ...
 * Page class
 */
class services_delete extends services
{
	...
	// Page object name
	public $PageObjName = "services_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("serviceslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("serviceslist.php"); // Return to list
			}
		}
	}
