 ...
 * Page class
 */
class district_add extends district
{
	...
	// Page object name
	public $PageObjName = "district_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("district_id") !== NULL) {
				...
				$this->setKey("district_id", $this->district_id->CurrentValue); // Set up key
			} else {
				$this->setKey("district_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "districtview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->district_division_id->CurrentValue = NULL;
		$this->district_division_id->OldValue = $this->district_division_id->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['district_division_id'] = $this->district_division_id->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// district_division_id
		$this->district_division_id->setDbValueDef($rsnew, $this->district_division_id->CurrentValue, 0, FALSE);
