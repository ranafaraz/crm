...
class services_add extends services
{
	...
	protected function loadDefaultValues()
	{
		...
		$this->service_logo->CurrentValue = NULL;
		$this->service_logo->OldValue = $this->service_logo->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['service_logo'] = $this->service_logo->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// service_logo
		$this->service_logo->setDbValueDef($rsnew, $this->service_logo->CurrentValue, "", FALSE);
