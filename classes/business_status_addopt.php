 ...
 * Page class
 */
class business_status_addopt extends business_status
{
	...
	// Page object name
	public $PageObjName = "business_status_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->business_status_caption->IsDetailKey) {
			$this->business_status_caption->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->b_status_desc->IsDetailKey) {
			$this->b_status_desc->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->business_status_caption->CurrentValue = ConvertToUtf8($this->business_status_caption->FormValue);
		$this->b_status_desc->CurrentValue = ConvertToUtf8($this->b_status_desc->FormValue);
	}
