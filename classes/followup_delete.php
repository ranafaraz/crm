 ...
 * Page class
 */
class followup_delete extends followup
{
	...
	// Page object name
	public $PageObjName = "followup_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("followuplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("followuplist.php"); // Return to list
			}
		}
	}
