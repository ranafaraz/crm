 ...
 * Page class
 */
class country_addopt extends country
{
	...
	// Page object name
	public $PageObjName = "country_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->country_name->IsDetailKey) {
			$this->country_name->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->country_name->CurrentValue = ConvertToUtf8($this->country_name->FormValue);
	}
