...
class quotation_add extends quotation
{
	...
	protected function addRow($rsold = NULL)
	{
		...
		// quote_issue_date
		$this->quote_issue_date->setDbValueDef($rsnew, UnFormatDateTime($this->quote_issue_date->CurrentValue, 2), CurrentDate(), FALSE);

		// quote_due_date
		$this->quote_due_date->setDbValueDef($rsnew, UnFormatDateTime($this->quote_due_date->CurrentValue, 2), CurrentDate(), FALSE);
