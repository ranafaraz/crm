 ...
 * Page class
 */
class sms_package_delete extends sms_package
{
	...
	// Page object name
	public $PageObjName = "sms_package_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("sms_packagelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("sms_packagelist.php"); // Return to list
			}
		}
	}
