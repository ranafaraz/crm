 ...
 * Page class
 */
class quotation_delete extends quotation
{
	...
	// Page object name
	public $PageObjName = "quotation_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("quotationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("quotationlist.php"); // Return to list
			}
		}
	}
