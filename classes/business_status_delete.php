 ...
 * Page class
 */
class business_status_delete extends business_status
{
	...
	// Page object name
	public $PageObjName = "business_status_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("business_statuslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("business_statuslist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['business_status_id'];
