 ...
 * Page class
 */
class district_delete extends district
{
	...
	// Page object name
	public $PageObjName = "district_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("districtlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("districtlist.php"); // Return to list
			}
		}
	}
