 ...
 * Page class
 */
class organization_delete extends organization
{
	...
	// Page object name
	public $PageObjName = "organization_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("organizationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("organizationlist.php"); // Return to list
			}
		}
	}
