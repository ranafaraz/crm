 ...
 * Page class
 */
class division_addopt extends division
{
	...
	// Page object name
	public $PageObjName = "division_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->division_state_id->IsDetailKey) {
			$this->division_state_id->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->division_name->IsDetailKey) {
			$this->division_name->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->division_state_id->CurrentValue = ConvertToUtf8($this->division_state_id->FormValue);
		$this->division_name->CurrentValue = ConvertToUtf8($this->division_name->FormValue);
	}
