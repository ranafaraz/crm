 ...
 * Page class
 */
class acc_transaction_delete extends acc_transaction
{
	...
	// Page object name
	public $PageObjName = "acc_transaction_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("acc_transactionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("acc_transactionlist.php"); // Return to list
			}
		}
	}
