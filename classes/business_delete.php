 ...
 * Page class
 */
class business_delete extends business
{
	...
	// Page object name
	public $PageObjName = "business_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("businesslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("businesslist.php"); // Return to list
			}
		}
	}
