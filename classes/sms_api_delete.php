 ...
 * Page class
 */
class sms_api_delete extends sms_api
{
	...
	// Page object name
	public $PageObjName = "sms_api_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("sms_apilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("sms_apilist.php"); // Return to list
			}
		}
	}
