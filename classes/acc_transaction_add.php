 ...
 * Page class
 */
class acc_transaction_add extends acc_transaction
{
	...
	// Page object name
	public $PageObjName = "acc_transaction_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("acc_trans_id") !== NULL) {
				...
				$this->setKey("acc_trans_id", $this->acc_trans_id->CurrentValue); // Set up key
			} else {
				$this->setKey("acc_trans_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "acc_transactionview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->acc_trans_id->OldValue = $this->acc_trans_id->CurrentValue;
		$this->acc_trans_branch_id->CurrentValue = NULL;
		$this->acc_trans_branch_id->OldValue = $this->acc_trans_branch_id->CurrentValue;
		$this->acc_trans_acc_head_id->CurrentValue = NULL;
		$this->acc_trans_acc_head_id->OldValue = $this->acc_trans_acc_head_id->CurrentValue;
		$this->acc_trans_narration->CurrentValue = NULL;
		$this->acc_trans_narration->OldValue = $this->acc_trans_narration->CurrentValue;
		$this->acc_trans_amount->CurrentValue = NULL;
		$this->acc_trans_amount->OldValue = $this->acc_trans_amount->CurrentValue;
		$this->acc_trans_date->CurrentValue = NULL;
		$this->acc_trans_date->OldValue = $this->acc_trans_date->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['acc_trans_id'] = $this->acc_trans_id->CurrentValue;
		$row['acc_trans_branch_id'] = $this->acc_trans_branch_id->CurrentValue;
		$row['acc_trans_acc_head_id'] = $this->acc_trans_acc_head_id->CurrentValue;
		$row['acc_trans_narration'] = $this->acc_trans_narration->CurrentValue;
		$row['acc_trans_amount'] = $this->acc_trans_amount->CurrentValue;
		$row['acc_trans_date'] = $this->acc_trans_date->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// acc_trans_branch_id
		$this->acc_trans_branch_id->setDbValueDef($rsnew, $this->acc_trans_branch_id->CurrentValue, 0, FALSE);

		// acc_trans_acc_head_id
		$this->acc_trans_acc_head_id->setDbValueDef($rsnew, $this->acc_trans_acc_head_id->CurrentValue, 0, FALSE);

		// acc_trans_narration
		$this->acc_trans_narration->setDbValueDef($rsnew, $this->acc_trans_narration->CurrentValue, "", FALSE);

		// acc_trans_amount
		$this->acc_trans_amount->setDbValueDef($rsnew, $this->acc_trans_amount->CurrentValue, 0, FALSE);

		// acc_trans_date
		$this->acc_trans_date->setDbValueDef($rsnew, UnFormatDateTime($this->acc_trans_date->CurrentValue, 0), CurrentDate(), FALSE);
