 ...
 * Page class
 */
class tehsil_delete extends tehsil
{
	...
	// Page object name
	public $PageObjName = "tehsil_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tehsillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tehsillist.php"); // Return to list
			}
		}
	}
