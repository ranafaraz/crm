 ...
 * Page class
 */
class services_availed_by_customer_delete extends services_availed_by_customer
{
	...
	// Page object name
	public $PageObjName = "services_availed_by_customer_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("services_availed_by_customerlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("services_availed_by_customerlist.php"); // Return to list
			}
		}
	}
