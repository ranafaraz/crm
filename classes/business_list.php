 ...
 * Page class
 */
class business_list extends business
{
	...
	// Page object name
	public $PageObjName = "business_list";

	// Grid form hidden field names
	public $FormName = "fbusinesslist";
	...
	public function __construct()
	{
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fbusinesslistsrch";
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->b_id->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->b_id->OldValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->b_owner->AdvancedSearch->toJson(), ","); // Field b_owner
		$filterList = Concat($filterList, $this->b_contact->AdvancedSearch->toJson(), ","); // Field b_contact
		$filterList = Concat($filterList, $this->b_address->AdvancedSearch->toJson(), ","); // Field b_address
		$filterList = Concat($filterList, $this->b_email->AdvancedSearch->toJson(), ","); // Field b_email
		$filterList = Concat($filterList, $this->b_ntn->AdvancedSearch->toJson(), ","); // Field b_ntn
		$filterList = Concat($filterList, $this->b_logo->AdvancedSearch->toJson(), ","); // Field b_logo
		$filterList = Concat($filterList, $this->b_no_of_emp->AdvancedSearch->toJson(), ","); // Field b_no_of_emp
		$filterList = Concat($filterList, $this->b_since->AdvancedSearch->toJson(), ","); // Field b_since
		$filterList = Concat($filterList, $this->b_no_of_branches->AdvancedSearch->toJson(), ","); // Field b_no_of_branches
		$filterList = Concat($filterList, $this->b_deal_with_referral->AdvancedSearch->toJson(), ","); // Field b_deal_with_referral
		$filterList = Concat($filterList, $this->b_comments->AdvancedSearch->toJson(), ","); // Field b_comments
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fbusinesslistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field b_branch_id
		$this->b_branch_id->AdvancedSearch->SearchValue = @$filter["x_b_branch_id"];
		$this->b_branch_id->AdvancedSearch->SearchOperator = @$filter["z_b_branch_id"];
		$this->b_branch_id->AdvancedSearch->SearchCondition = @$filter["v_b_branch_id"];
		$this->b_branch_id->AdvancedSearch->SearchValue2 = @$filter["y_b_branch_id"];
		$this->b_branch_id->AdvancedSearch->SearchOperator2 = @$filter["w_b_branch_id"];
		$this->b_branch_id->AdvancedSearch->save();

		// Field b_b_type_id
		$this->b_b_type_id->AdvancedSearch->SearchValue = @$filter["x_b_b_type_id"];
		$this->b_b_type_id->AdvancedSearch->SearchOperator = @$filter["z_b_b_type_id"];
		$this->b_b_type_id->AdvancedSearch->SearchCondition = @$filter["v_b_b_type_id"];
		$this->b_b_type_id->AdvancedSearch->SearchValue2 = @$filter["y_b_b_type_id"];
		...
		$this->b_b_status_id->AdvancedSearch->SearchCondition = @$filter["v_b_b_status_id"];
		...
		$this->b_city_id->AdvancedSearch->SearchOperator = @$filter["z_b_city_id"];
		$this->b_city_id->AdvancedSearch->SearchCondition = @$filter["v_b_city_id"];
		$this->b_city_id->AdvancedSearch->SearchValue2 = @$filter["y_b_city_id"];
		$this->b_city_id->AdvancedSearch->SearchOperator2 = @$filter["w_b_city_id"];
		$this->b_city_id->AdvancedSearch->save();

		// Field b_referral_id
		$this->b_referral_id->AdvancedSearch->SearchValue = @$filter["x_b_referral_id"];
		$this->b_referral_id->AdvancedSearch->SearchOperator = @$filter["z_b_referral_id"];
		$this->b_referral_id->AdvancedSearch->SearchCondition = @$filter["v_b_referral_id"];
		$this->b_referral_id->AdvancedSearch->SearchValue2 = @$filter["y_b_referral_id"];
		$this->b_referral_id->AdvancedSearch->SearchOperator2 = @$filter["w_b_referral_id"];
		$this->b_referral_id->AdvancedSearch->save();
		...
		// Field b_owner
		$this->b_owner->AdvancedSearch->SearchValue = @$filter["x_b_owner"];
		$this->b_owner->AdvancedSearch->SearchOperator = @$filter["z_b_owner"];
		$this->b_owner->AdvancedSearch->SearchCondition = @$filter["v_b_owner"];
		$this->b_owner->AdvancedSearch->SearchValue2 = @$filter["y_b_owner"];
		$this->b_owner->AdvancedSearch->SearchOperator2 = @$filter["w_b_owner"];
		$this->b_owner->AdvancedSearch->save();

		// Field b_contact
		$this->b_contact->AdvancedSearch->SearchValue = @$filter["x_b_contact"];
		$this->b_contact->AdvancedSearch->SearchOperator = @$filter["z_b_contact"];
		$this->b_contact->AdvancedSearch->SearchCondition = @$filter["v_b_contact"];
		$this->b_contact->AdvancedSearch->SearchValue2 = @$filter["y_b_contact"];
		$this->b_contact->AdvancedSearch->SearchOperator2 = @$filter["w_b_contact"];
		$this->b_contact->AdvancedSearch->save();

		// Field b_address
		$this->b_address->AdvancedSearch->SearchValue = @$filter["x_b_address"];
		$this->b_address->AdvancedSearch->SearchOperator = @$filter["z_b_address"];
		$this->b_address->AdvancedSearch->SearchCondition = @$filter["v_b_address"];
		$this->b_address->AdvancedSearch->SearchValue2 = @$filter["y_b_address"];
		$this->b_address->AdvancedSearch->SearchOperator2 = @$filter["w_b_address"];
		$this->b_address->AdvancedSearch->save();

		// Field b_email
		$this->b_email->AdvancedSearch->SearchValue = @$filter["x_b_email"];
		$this->b_email->AdvancedSearch->SearchOperator = @$filter["z_b_email"];
		$this->b_email->AdvancedSearch->SearchCondition = @$filter["v_b_email"];
		$this->b_email->AdvancedSearch->SearchValue2 = @$filter["y_b_email"];
		$this->b_email->AdvancedSearch->SearchOperator2 = @$filter["w_b_email"];
		$this->b_email->AdvancedSearch->save();

		// Field b_ntn
		$this->b_ntn->AdvancedSearch->SearchValue = @$filter["x_b_ntn"];
		$this->b_ntn->AdvancedSearch->SearchOperator = @$filter["z_b_ntn"];
		$this->b_ntn->AdvancedSearch->SearchCondition = @$filter["v_b_ntn"];
		$this->b_ntn->AdvancedSearch->SearchValue2 = @$filter["y_b_ntn"];
		$this->b_ntn->AdvancedSearch->SearchOperator2 = @$filter["w_b_ntn"];
		$this->b_ntn->AdvancedSearch->save();

		// Field b_logo
		$this->b_logo->AdvancedSearch->SearchValue = @$filter["x_b_logo"];
		$this->b_logo->AdvancedSearch->SearchOperator = @$filter["z_b_logo"];
		$this->b_logo->AdvancedSearch->SearchCondition = @$filter["v_b_logo"];
		$this->b_logo->AdvancedSearch->SearchValue2 = @$filter["y_b_logo"];
		$this->b_logo->AdvancedSearch->SearchOperator2 = @$filter["w_b_logo"];
		$this->b_logo->AdvancedSearch->save();

		// Field b_no_of_emp
		$this->b_no_of_emp->AdvancedSearch->SearchValue = @$filter["x_b_no_of_emp"];
		$this->b_no_of_emp->AdvancedSearch->SearchOperator = @$filter["z_b_no_of_emp"];
		$this->b_no_of_emp->AdvancedSearch->SearchCondition = @$filter["v_b_no_of_emp"];
		$this->b_no_of_emp->AdvancedSearch->SearchValue2 = @$filter["y_b_no_of_emp"];
		$this->b_no_of_emp->AdvancedSearch->SearchOperator2 = @$filter["w_b_no_of_emp"];
		$this->b_no_of_emp->AdvancedSearch->save();

		// Field b_since
		$this->b_since->AdvancedSearch->SearchValue = @$filter["x_b_since"];
		$this->b_since->AdvancedSearch->SearchOperator = @$filter["z_b_since"];
		$this->b_since->AdvancedSearch->SearchCondition = @$filter["v_b_since"];
		$this->b_since->AdvancedSearch->SearchValue2 = @$filter["y_b_since"];
		$this->b_since->AdvancedSearch->SearchOperator2 = @$filter["w_b_since"];
		$this->b_since->AdvancedSearch->save();

		// Field b_no_of_branches
		$this->b_no_of_branches->AdvancedSearch->SearchValue = @$filter["x_b_no_of_branches"];
		$this->b_no_of_branches->AdvancedSearch->SearchOperator = @$filter["z_b_no_of_branches"];
		$this->b_no_of_branches->AdvancedSearch->SearchCondition = @$filter["v_b_no_of_branches"];
		$this->b_no_of_branches->AdvancedSearch->SearchValue2 = @$filter["y_b_no_of_branches"];
		$this->b_no_of_branches->AdvancedSearch->SearchOperator2 = @$filter["w_b_no_of_branches"];
		$this->b_no_of_branches->AdvancedSearch->save();

		// Field b_deal_with_referral
		$this->b_deal_with_referral->AdvancedSearch->SearchValue = @$filter["x_b_deal_with_referral"];
		$this->b_deal_with_referral->AdvancedSearch->SearchOperator = @$filter["z_b_deal_with_referral"];
		$this->b_deal_with_referral->AdvancedSearch->SearchCondition = @$filter["v_b_deal_with_referral"];
		$this->b_deal_with_referral->AdvancedSearch->SearchValue2 = @$filter["y_b_deal_with_referral"];
		$this->b_deal_with_referral->AdvancedSearch->SearchOperator2 = @$filter["w_b_deal_with_referral"];
		$this->b_deal_with_referral->AdvancedSearch->save();

		// Field b_comments
		$this->b_comments->AdvancedSearch->SearchValue = @$filter["x_b_comments"];
		$this->b_comments->AdvancedSearch->SearchOperator = @$filter["z_b_comments"];
		$this->b_comments->AdvancedSearch->SearchCondition = @$filter["v_b_comments"];
		$this->b_comments->AdvancedSearch->SearchValue2 = @$filter["y_b_comments"];
		$this->b_comments->AdvancedSearch->SearchOperator2 = @$filter["w_b_comments"];
		$this->b_comments->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->b_name, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_owner, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_contact, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_address, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_email, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_ntn, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_logo, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_since, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_deal_with_referral, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->b_comments, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->b_owner); // b_owner
			$this->updateSort($this->b_contact); // b_contact
			$this->updateSort($this->b_address); // b_address
			$this->updateSort($this->b_email); // b_email
			$this->updateSort($this->b_ntn); // b_ntn
			$this->updateSort($this->b_logo); // b_logo
			$this->updateSort($this->b_no_of_emp); // b_no_of_emp
			$this->updateSort($this->b_since); // b_since
			$this->updateSort($this->b_no_of_branches); // b_no_of_branches
			$this->updateSort($this->b_deal_with_referral); // b_deal_with_referral
			$this->updateSort($this->b_comments); // b_comments
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->b_name->setSort("");
				$this->b_owner->setSort("");
				$this->b_contact->setSort("");
				$this->b_address->setSort("");
				$this->b_email->setSort("");
				$this->b_ntn->setSort("");
				$this->b_logo->setSort("");
				$this->b_no_of_emp->setSort("");
				$this->b_since->setSort("");
				$this->b_no_of_branches->setSort("");
				$this->b_deal_with_referral->setSort("");
				$this->b_comments->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fbusinesslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fbusinesslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fbusinesslist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fbusinesslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
