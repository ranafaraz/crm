 ...
 * Page class
 */
class cus_support_delete extends cus_support
{
	...
	// Page object name
	public $PageObjName = "cus_support_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("cus_supportlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("cus_supportlist.php"); // Return to list
			}
		}
	}
