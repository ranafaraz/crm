 ...
 * Page class
 */
class invoices_delete extends invoices
{
	...
	// Page object name
	public $PageObjName = "invoices_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("invoiceslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("invoiceslist.php"); // Return to list
			}
		}
	}
