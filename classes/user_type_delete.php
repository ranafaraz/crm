 ...
 * Page class
 */
class user_type_delete extends user_type
{
	...
	// Page object name
	public $PageObjName = "user_type_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("user_typelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("user_typelist.php"); // Return to list
			}
		}
	}
