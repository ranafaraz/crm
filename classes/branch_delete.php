 ...
 * Page class
 */
class branch_delete extends branch
{
	...
	// Page object name
	public $PageObjName = "branch_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("branchlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("branchlist.php"); // Return to list
			}
		}
	}
