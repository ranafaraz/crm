 ...
 * Page class
 */
class business_status_add extends business_status
{
	...
	// Page object name
	public $PageObjName = "business_status_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("business_status_id") !== NULL) {
				...
				$this->setKey("business_status_id", $this->business_status_id->CurrentValue); // Set up key
			} else {
				$this->setKey("business_status_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "business_statusview.php")
