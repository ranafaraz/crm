...
<input type="hidden" name="fc_x_ref_letter_scanned" id= "fc_x_ref_letter_scanned" value="<?php echo $reference_letter_edit->ref_letter_scanned->UploadMaxFileCount ?>">
</div>
