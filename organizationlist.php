...
<?php } ?>
<form name="forganizationlist" id="forganizationlist" class="ew-horizontal ew-form ew-list-form ew-multi-column-form" action="<?php echo CurrentPageName() ?>" method="post">
...
?>
<div class="<?php echo $organization_list->getMultiColumnClass() ?>" <?php echo $organization->rowAttributes() ?>>
	<div class="card ew-card">
	<div class="card-body">
	<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
	<table class="table table-striped table-sm ew-view-table">
	<?php } ?>
	<?php if ($organization_list->org_id->Visible) { // org_id ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_id">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_id) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_id->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_id) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_id->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_id->viewAttributes() ?>><?php echo $organization_list->org_id->getViewValue() ?></span>
		...
		<div class="form-group row organization_org_id">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_id->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_id->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_id">
<span<?php echo $organization_list->org_id->viewAttributes() ?>><?php echo $organization_list->org_id->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_city_id->Visible) { // org_city_id ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_city_id">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_city_id) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_city_id->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_city_id) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_city_id->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_city_id->viewAttributes() ?>><?php echo $organization_list->org_city_id->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_city_id">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_city_id->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_city_id->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_city_id">
<span<?php echo $organization_list->org_city_id->viewAttributes() ?>><?php echo $organization_list->org_city_id->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_name->Visible) { // org_name ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_name">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_name) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_name->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_name) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_name->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_name->viewAttributes() ?>><?php echo $organization_list->org_name->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_name">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_name->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_name->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_name">
<span<?php echo $organization_list->org_name->viewAttributes() ?>><?php echo $organization_list->org_name->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_head_office->Visible) { // org_head_office ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_head_office">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_head_office) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_head_office->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_head_office) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_head_office->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_head_office->viewAttributes() ?>><?php echo $organization_list->org_head_office->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_head_office">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_head_office->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_head_office->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_head_office">
<span<?php echo $organization_list->org_head_office->viewAttributes() ?>><?php echo $organization_list->org_head_office->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_owner->Visible) { // org_owner ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_owner">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_owner) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_owner->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_owner) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_owner->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_owner->viewAttributes() ?>><?php echo $organization_list->org_owner->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_owner">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_owner->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_owner->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_owner">
<span<?php echo $organization_list->org_owner->viewAttributes() ?>><?php echo $organization_list->org_owner->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_contact_no->Visible) { // org_contact_no ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_contact_no">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_contact_no) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_contact_no->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_contact_no) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_contact_no->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_contact_no->viewAttributes() ?>><?php echo $organization_list->org_contact_no->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_contact_no">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_contact_no->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_contact_no->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_contact_no">
<span<?php echo $organization_list->org_contact_no->viewAttributes() ?>><?php echo $organization_list->org_contact_no->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_logo->Visible) { // org_logo ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_logo">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_logo) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_logo->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_logo) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_logo->cellAttributes() ?>>
...
<span><?php echo GetFileViewTag($organization_list->org_logo, $organization_list->org_logo->getViewValue(), FALSE) ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_logo">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_logo->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_logo->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_logo">
<span><?php echo GetFileViewTag($organization_list->org_logo, $organization_list->org_logo->getViewValue(), FALSE) ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_bank_acc->Visible) { // org_bank_acc ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_bank_acc">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_bank_acc) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_bank_acc->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_bank_acc) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_bank_acc->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_bank_acc->viewAttributes() ?>><?php echo $organization_list->org_bank_acc->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_bank_acc">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_bank_acc->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_bank_acc->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_bank_acc">
<span<?php echo $organization_list->org_bank_acc->viewAttributes() ?>><?php echo $organization_list->org_bank_acc->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_ntn->Visible) { // org_ntn ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_ntn">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_ntn) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_ntn->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_ntn) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_ntn->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_ntn->viewAttributes() ?>><?php echo $organization_list->org_ntn->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_ntn">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_ntn->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_ntn->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_ntn">
<span<?php echo $organization_list->org_ntn->viewAttributes() ?>><?php echo $organization_list->org_ntn->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_email->Visible) { // org_email ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_email">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_email) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_email->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_email) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_email->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_email->viewAttributes() ?>><?php echo $organization_list->org_email->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_email">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_email->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_email->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_email">
<span<?php echo $organization_list->org_email->viewAttributes() ?>><?php echo $organization_list->org_email->getViewValue() ?></span>
</span>
</div></div>
	...
	<?php if ($organization_list->org_website->Visible) { // org_website ?>
		<?php if ($organization->RowType == ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ew-table-header <?php echo $organization_list->TableLeftColumnClass ?>"><span class="organization_org_website">
<?php if ($organization_list->isExport() || $organization_list->SortUrl($organization_list->org_website) == "") { ?>
				<div class="ew-table-header-caption"><?php echo $organization_list->org_website->caption() ?></div>
<?php } else { ?>
				<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $organization_list->SortUrl($organization_list->org_website) ?>', 1);">
...
<?php } ?>
			...
			<td <?php echo $organization_list->org_website->cellAttributes() ?>>
...
<span<?php echo $organization_list->org_website->viewAttributes() ?>><?php echo $organization_list->org_website->getViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group row organization_org_website">
			<label class="<?php echo $organization_list->LeftColumnClass ?>"><?php echo $organization_list->org_website->caption() ?></label>
			<div class="<?php echo $organization_list->RightColumnClass ?>"><div <?php echo $organization_list->org_website->cellAttributes() ?>>
<span id="el<?php echo $organization_list->RowCount ?>_organization_org_website">
<span<?php echo $organization_list->org_website->viewAttributes() ?>><?php echo $organization_list->org_website->getViewValue() ?></span>
</span>
</div></div>
...
$organization_list->ListOptions->render("body", "bottom", $organization_list->RowCount);
?>
