		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php } ?>
				...
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($branch_add->branch_org_id->errorMessage()) ?>");
...
<input type="text" data-table="branch" data-field="x_branch_org_id" name="x_branch_org_id" id="x_branch_org_id" size="30" maxlength="12" placeholder="<?php echo HtmlEncode($branch_add->branch_org_id->getPlaceHolder()) ?>" value="<?php echo $branch_add->branch_org_id->EditValue ?>"<?php echo $branch_add->branch_org_id->editAttributes() ?>>
</span>
...
<input type="text" data-table="branch" data-field="x_branch_address" name="x_branch_address" id="x_branch_address" size="30" maxlength="100" placeholder="<?php echo HtmlEncode($branch_add->branch_address->getPlaceHolder()) ?>" value="<?php echo $branch_add->branch_address->EditValue ?>"<?php echo $branch_add->branch_address->editAttributes() ?>>
</span>
