...
<div class="input-group">
	<div class="custom-file">
		<input type="file" class="custom-file-input" title="<?php echo $reference_letter_add->ref_letter_scanned->title() ?>" data-table="reference_letter" data-field="x_ref_letter_scanned" name="x_ref_letter_scanned" id="x_ref_letter_scanned" lang="<?php echo CurrentLanguageID() ?>" multiple="multiple"<?php echo $reference_letter_add->ref_letter_scanned->editAttributes() ?><?php if ($reference_letter_add->ref_letter_scanned->ReadOnly || $reference_letter_add->ref_letter_scanned->Disabled) echo " disabled"; ?>>
		<label class="custom-file-label ew-file-label" for="x_ref_letter_scanned"><?php echo $Language->phrase("ChooseFiles") ?></label>
	</div>
</div>
...
<input type="hidden" name="fc_x_ref_letter_scanned" id= "fc_x_ref_letter_scanned" value="<?php echo $reference_letter_add->ref_letter_scanned->UploadMaxFileCount ?>">
</div>
