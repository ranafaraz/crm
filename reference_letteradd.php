		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php } ?>
				...
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($reference_letter_add->ref_letter_branch_id->errorMessage()) ?>");
			...
			<?php if ($reference_letter_add->ref_letter_scanned->Required) { ?>
				...
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $reference_letter_add->ref_letter_scanned->caption(), $reference_letter_add->ref_letter_scanned->RequiredErrorMessage)) ?>");
			<?php } ?>
...
<input type="text" data-table="reference_letter" data-field="x_ref_letter_branch_id" name="x_ref_letter_branch_id" id="x_ref_letter_branch_id" size="30" maxlength="12" placeholder="<?php echo HtmlEncode($reference_letter_add->ref_letter_branch_id->getPlaceHolder()) ?>" value="<?php echo $reference_letter_add->ref_letter_branch_id->EditValue ?>"<?php echo $reference_letter_add->ref_letter_branch_id->editAttributes() ?>>
</span>
...
<?php if ($reference_letter_add->ref_letter_content->Visible) { // ref_letter_content ?>
	<div id="r_ref_letter_content" class="form-group row">
		<label id="elh_reference_letter_ref_letter_content" for="x_ref_letter_content" class="<?php echo $reference_letter_add->LeftColumnClass ?>"><?php echo $reference_letter_add->ref_letter_content->caption() ?><?php echo $reference_letter_add->ref_letter_content->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($reference_letter_add->ref_letter_scanned->Visible) { // ref_letter_scanned ?>
	<div id="r_ref_letter_scanned" class="form-group row">
		<label id="elh_reference_letter_ref_letter_scanned" for="x_ref_letter_scanned" class="<?php echo $reference_letter_add->LeftColumnClass ?>"><?php echo $reference_letter_add->ref_letter_scanned->caption() ?><?php echo $reference_letter_add->ref_letter_scanned->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" data-table="reference_letter" data-field="x_ref_letter_scanned" name="x_ref_letter_scanned" id="x_ref_letter_scanned" size="30" maxlength="100" placeholder="<?php echo HtmlEncode($reference_letter_add->ref_letter_scanned->getPlaceHolder()) ?>" value="<?php echo $reference_letter_add->ref_letter_scanned->EditValue ?>"<?php echo $reference_letter_add->ref_letter_scanned->editAttributes() ?>>
</span>
...
loadjs.ready(["freference_letteradd", "datetimepicker"], function() {
	ew.createDateTimePicker("freference_letteradd", "x_ref_letter_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($reference_letter_add->ref_letter_comments->Visible) { // ref_letter_comments ?>
	<div id="r_ref_letter_comments" class="form-group row">
		<label id="elh_reference_letter_ref_letter_comments" for="x_ref_letter_comments" class="<?php echo $reference_letter_add->LeftColumnClass ?>"><?php echo $reference_letter_add->ref_letter_comments->caption() ?><?php echo $reference_letter_add->ref_letter_comments->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
