		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php } ?>
				...
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($referral_add->referral_branch_id->errorMessage()) ?>");
...
<input type="text" data-table="referral" data-field="x_referral_branch_id" name="x_referral_branch_id" id="x_referral_branch_id" size="30" maxlength="12" placeholder="<?php echo HtmlEncode($referral_add->referral_branch_id->getPlaceHolder()) ?>" value="<?php echo $referral_add->referral_branch_id->EditValue ?>"<?php echo $referral_add->referral_branch_id->editAttributes() ?>>
</span>
...
<?php if ($referral_add->referral_deal_signed->Visible) { // referral_deal_signed ?>
	<div id="r_referral_deal_signed" class="form-group row">
		<label id="elh_referral_referral_deal_signed" for="x_referral_deal_signed" class="<?php echo $referral_add->LeftColumnClass ?>"><?php echo $referral_add->referral_deal_signed->caption() ?><?php echo $referral_add->referral_deal_signed->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
