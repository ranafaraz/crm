...
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_org_city_id"><?php echo EmptyValue(strval($organization_add->org_city_id->ViewValue)) ? $Language->phrase("PleaseSelect") : $organization_add->org_city_id->ViewValue ?></div>
	<div class="input-group-append">
		<button type="button" title="<?php echo HtmlEncode(str_replace("%s", RemoveHtml($organization_add->org_city_id->caption()), $Language->phrase("LookupLink", TRUE))) ?>" class="ew-lookup-btn btn btn-default"<?php echo ($organization_add->org_city_id->ReadOnly || $organization_add->org_city_id->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x_org_city_id',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
		<button type="button" class="btn btn-default ew-add-opt-btn" id="aol_x_org_city_id" title="<?php echo HtmlTitle($Language->phrase("AddLink")) . "&nbsp;" . $organization_add->org_city_id->caption() ?>" data-title="<?php echo $organization_add->org_city_id->caption() ?>" onclick="ew.addOptionDialogShow({lnk:this,el:'x_org_city_id',url:'cityaddopt.php'});"><i class="fas fa-plus ew-icon"></i></button>
	</div>
</div>
<?php echo $organization_add->org_city_id->Lookup->getParamTag($organization_add, "p_x_org_city_id") ?>
<input type="hidden" data-table="organization" data-field="x_org_city_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $organization_add->org_city_id->displayValueSeparatorAttribute() ?>" name="x_org_city_id" id="x_org_city_id" value="<?php echo $organization_add->org_city_id->CurrentValue ?>"<?php echo $organization_add->org_city_id->editAttributes() ?>>
</span>
