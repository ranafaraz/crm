...
<div class="btn-group ew-dropdown-list" role="group">
	<div class="btn-group" role="group">
		<button type="button" class="btn form-control dropdown-toggle ew-dropdown-toggle" aria-haspopup="true" aria-expanded="false"<?php if ($organization_edit->org_city_id->ReadOnly) { ?> readonly<?php } else { ?>data-toggle="dropdown"<?php } ?>><?php echo $organization_edit->org_city_id->ViewValue ?></button>
		<div id="dsl_x_org_city_id" data-repeatcolumn="1" class="dropdown-menu">
			<div class="ew-items" style="overflow-x: hidden;">
<?php echo $organization_edit->org_city_id->radioButtonListHtml(TRUE, "x_org_city_id") ?>
			</div><!-- /.ew-items -->
		</div><!-- /.dropdown-menu -->
		<div id="tp_x_org_city_id" class="ew-template"><input type="radio" class="custom-control-input" data-table="organization" data-field="x_org_city_id" data-value-separator="<?php echo $organization_edit->org_city_id->displayValueSeparatorAttribute() ?>" name="x_org_city_id" id="x_org_city_id" value="{value}"<?php echo $organization_edit->org_city_id->editAttributes() ?>></div>
	</div><!-- /.btn-group -->
	<?php if (!$organization_edit->org_city_id->ReadOnly) { ?>
