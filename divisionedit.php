...
<div class="btn-group ew-dropdown-list" role="group">
	<div class="btn-group" role="group">
		<button type="button" class="btn form-control dropdown-toggle ew-dropdown-toggle" aria-haspopup="true" aria-expanded="false"<?php if ($division_edit->division_state_id->ReadOnly) { ?> readonly<?php } else { ?>data-toggle="dropdown"<?php } ?>><?php echo $division_edit->division_state_id->ViewValue ?></button>
		<div id="dsl_x_division_state_id" data-repeatcolumn="1" class="dropdown-menu">
			<div class="ew-items" style="overflow-x: hidden;">
<?php echo $division_edit->division_state_id->radioButtonListHtml(TRUE, "x_division_state_id") ?>
			</div><!-- /.ew-items -->
		</div><!-- /.dropdown-menu -->
		<div id="tp_x_division_state_id" class="ew-template"><input type="radio" class="custom-control-input" data-table="division" data-field="x_division_state_id" data-value-separator="<?php echo $division_edit->division_state_id->displayValueSeparatorAttribute() ?>" name="x_division_state_id" id="x_division_state_id" value="{value}"<?php echo $division_edit->division_state_id->editAttributes() ?>></div>
	</div><!-- /.btn-group -->
	<?php if (!$division_edit->division_state_id->ReadOnly) { ?>
