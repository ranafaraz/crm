		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php } ?>
				...
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($city_edit->city_tehsil_id->errorMessage()) ?>");
...
<input type="text" data-table="city" data-field="x_city_tehsil_id" name="x_city_tehsil_id" id="x_city_tehsil_id" size="30" maxlength="12" placeholder="<?php echo HtmlEncode($city_edit->city_tehsil_id->getPlaceHolder()) ?>" value="<?php echo $city_edit->city_tehsil_id->EditValue ?>"<?php echo $city_edit->city_tehsil_id->editAttributes() ?>>
</span>
