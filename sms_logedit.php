...
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_sms_log_sms_api_id"><?php echo EmptyValue(strval($sms_log_edit->sms_log_sms_api_id->ViewValue)) ? $Language->phrase("PleaseSelect") : $sms_log_edit->sms_log_sms_api_id->ViewValue ?></div>
	<div class="input-group-append">
		<button type="button" title="<?php echo HtmlEncode(str_replace("%s", RemoveHtml($sms_log_edit->sms_log_sms_api_id->caption()), $Language->phrase("LookupLink", TRUE))) ?>" class="ew-lookup-btn btn btn-default"<?php echo ($sms_log_edit->sms_log_sms_api_id->ReadOnly || $sms_log_edit->sms_log_sms_api_id->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x_sms_log_sms_api_id',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
	</div>
</div>
<?php echo $sms_log_edit->sms_log_sms_api_id->Lookup->getParamTag($sms_log_edit, "p_x_sms_log_sms_api_id") ?>
<input type="hidden" data-table="sms_log" data-field="x_sms_log_sms_api_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $sms_log_edit->sms_log_sms_api_id->displayValueSeparatorAttribute() ?>" name="x_sms_log_sms_api_id" id="x_sms_log_sms_api_id" value="<?php echo $sms_log_edit->sms_log_sms_api_id->CurrentValue ?>"<?php echo $sms_log_edit->sms_log_sms_api_id->editAttributes() ?>>
</span>
...
<input type="text" data-table="sms_log" data-field="x_sms_log_date" data-format="2" name="x_sms_log_date" id="x_sms_log_date" maxlength="10" placeholder="<?php echo HtmlEncode($sms_log_edit->sms_log_date->getPlaceHolder()) ?>" value="<?php echo $sms_log_edit->sms_log_date->EditValue ?>"<?php echo $sms_log_edit->sms_log_date->editAttributes() ?>>
...
loadjs.ready(["fsms_logedit", "datetimepicker"], function() {
	ew.createDateTimePicker("fsms_logedit", "x_sms_log_date", {"ignoreReadonly":true,"useCurrent":false,"format":2});
});
</script>
<?php } ?>
</span>
