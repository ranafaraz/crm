...
<input type="text" data-table="employees" data-field="x_emp_address" name="x_emp_address" id="x_emp_address" size="30" maxlength="100" placeholder="<?php echo HtmlEncode($employees_edit->emp_address->getPlaceHolder()) ?>" value="<?php echo $employees_edit->emp_address->EditValue ?>"<?php echo $employees_edit->emp_address->editAttributes() ?>>
</span>
